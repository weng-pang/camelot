...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sale_price' => ['type' => 'decimal', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'on_sale' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'sale_price' => 1.5,
                'on_sale' => 1,
                'created' => '2018-06-30 08:23:31',
                'modified' => '2018-06-30 08:23:31',
                'archived' => 1,
                'stock' => 1
            ],
        ];
